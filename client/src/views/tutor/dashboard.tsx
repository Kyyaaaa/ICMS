    ...
    return (
        <div className="space-y-6 animate-fade-in-up pb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    { title: 'Active Classes', value: '4', icon: BookOpen, color: 'text-blue-600', bg: 'bg-blue-100' },
                    { title: 'Upcoming Sessions', value: '12', icon: Calendar, color: 'text-emerald-600', bg: 'bg-emerald-100' },
                    { title: 'Pending Requests', value: '2', icon: RefreshCcw, color: 'text-amber-600', bg: 'bg-amber-100' },
                    { title: 'Total Students', value: '86', icon: Users, color: 'text-purple-600', bg: 'bg-purple-100' }
                ].map((stat, i) => (
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="bg-white rounded-2xl shadow-sm border border-[#e0e3e5] p-6">
                        ...
                        <div className="space-y-4">
                            {[
                                { title: 'Mark Attendance for IE1601', type: 'Class IE1601', time: '1 hour ago', icon: CheckSquare, bg: 'bg-blue-50', color: 'text-blue-600', link: '/tutor/attendance' },
                                { title: 'Complete Session Report', type: 'Class TOEIC-B12', time: '3 hours ago', icon: FileText, bg: 'bg-purple-50', color: 'text-purple-600', link: '/tutor/dashboard' },
                                { title: 'Confirm Rescheduled Session', type: 'Class ENG401', time: '1 day ago', icon: Calendar, bg: 'bg-amber-50', color: 'text-amber-600', link: '/tutor/change-requests' },
                            ].map((task, i) => (
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-[#e0e3e5] p-6">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                            {[
                                ...
                                { name: 'Mark Attendance', icon: CheckSquare, link: '/tutor/attendance', color: 'bg-emerald-50 text-emerald-700 hover:bg-emerald-100' },
