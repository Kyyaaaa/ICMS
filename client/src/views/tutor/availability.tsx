    ...
    return (
        <div className="p-6 max-w-7xl mx-auto animate-fade-in">
            <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                    <h1 className="text-[28px] font-bold text-[#181c1e] tracking-tight">Availability Registration</h1>
                    <p className="text-[#43474e] text-[15px]">Register your available time slots for the upcoming semester.</p>
                </div>
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-[#e0e3e5] p-12 text-center text-[#74777f]">
                Availability calendar form will go here.
            </div>
        </div>
    );
};
