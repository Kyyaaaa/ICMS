...
const TutorSalaryHistory = () => {
    ...
    const salaryRecords: SalaryRecord[] = [
        { id: 'PAY-T-1004', period: '10-2026', baseSalary: 15000000, bonuses: 2000000, deductions: 0, netPay: 17000000, payDate: '05-11-2026', status: 'Paid' },
        { id: 'PAY-T-1003', period: '09-2026', baseSalary: 14500000, bonuses: 1500000, deductions: 500000, netPay: 15500000, payDate: '05-10-2026', status: 'Paid' },
        { id: 'PAY-T-1002', period: '08-2026', baseSalary: 16000000, bonuses: 1000000, deductions: 0, netPay: 17000000, payDate: '05-09-2026', status: 'Paid' },
        { id: 'PAY-T-1001', period: '07-2026', baseSalary: 14000000, bonuses: 500000, deductions: 0, netPay: 14500000, payDate: '05-08-2026', status: 'Paid' },
        { id: 'PAY-T-1000', period: '06-2026', baseSalary: 13500000, bonuses: 2500000, deductions: 200000, netPay: 15800000, payDate: '05-07-2026', status: 'Paid' },
    ];
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="flex justify-between items-start text-[14px]">
                                                <div className="flex flex-col">
                                                    <span className="text-[#43474e] font-medium">Teaching Classes (24 sessions)</span>
                                                    <span className="text-[12px] text-[#74777f]">625,000 đ/session</span>
                                                </div>
