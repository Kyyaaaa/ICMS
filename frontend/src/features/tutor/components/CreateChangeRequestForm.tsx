                ...
                <div className="overflow-y-auto p-6">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                <label className="block text-xs font-bold text-[#002045] mb-2">Request Type <span className="text-rose-500">*</span></label>
                            ...
                            <div>
                                <label className="block text-xs font-bold text-[#002045] mb-2">Class & Session <span className="text-rose-500">*</span></label>
                                <select 
                                    required
                                    value={newClassSession}
                                    onChange={(e) => setNewClassSession(e.target.value)}
                                    className="w-full p-2.5 bg-white border border-[#c4c6cf] rounded-xl focus:outline-none focus:border-[#0061a5] focus:ring-1 focus:ring-[#0061a5] text-sm h-11.5"
                                >
                    ...
                    {newType === 'Reschedule' && (
                        <div className="p-4 bg-[#f0f7ff] border border-[#bbdefb] rounded-xl space-y-4">
                            <p className="text-xs font-bold text-[#002045]">Proposed New Schedule (Optional)</p>
                            
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <label className="block text-xs font-bold text-[#43474e] mb-1">Select Date</label>
                                    <input 
                                        type="date" 
                                        className="w-full px-3 py-2 bg-white border border-[#c4c6cf] rounded-lg focus:outline-none focus:border-[#0061a5] text-xs font-medium"
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-[#43474e] mb-1">Time Slot</label>
                                    <select 
                                        className="w-full px-3 py-2 bg-white border border-[#c4c6cf] rounded-lg focus:outline-none focus:border-[#0061a5] text-xs font-medium disabled:bg-[#f1f4f6] disabled:text-[#74777f]"
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-[#43474e] mb-1">Room</label>
                                    <select 
                                        className="w-full px-3 py-2 bg-white border border-[#c4c6cf] rounded-lg focus:outline-none focus:border-[#0061a5] text-xs font-medium disabled:bg-[#f1f4f6] disabled:text-[#74777f]"
                            ...
                            <p className="text-xs text-[#74777f]">Leave blank if you want staff to arrange a time for you.</p>
                        </div>
                    )}

                    <div>
                        <label className="block text-xs font-bold text-[#002045] mb-2">Reason <span className="text-rose-500">*</span></label>
                        <textarea 
                            required
                            rows={3} 
                            value={newReason}
