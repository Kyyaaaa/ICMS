    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-[#e0e3e5] p-6 h-full flex flex-col">
            <div className="mb-6">
                ...
                <p className="text-sm text-[#43474e] mt-1">Your teaching schedule</p>
            </div>
                ...
                {classes.map((cls, i) => (
                    <div key={i} className="relative pl-3 border-l-2 border-[#e0e3e5] pb-4 last:pb-0">
                        ...
                        <div className="flex items-center justify-between gap-2 text-[11px] text-[#74777f]">
                            <span className="font-medium text-[#43474e]">{cls.time}</span>
            ...
            <Link to="/tutor/schedule" className="mt-6 w-full py-2.5 rounded-lg border border-[#c4c6cf] text-[#43474e] font-bold text-sm hover:bg-[#f8f9fa] transition-colors flex items-center justify-center gap-2">
                View Full Schedule
            </Link>
        </div>
    );
