...
export const DashboardStats = ({ stats }: DashboardStatsProps) => {
    const statsList = [
        { title: 'Total Revenue', value: `${stats.totalRevenue.toLocaleString('en-US')} VND`, icon: DollarSign, colorClass: 'bg-[#d2e4ff] text-[#0061a5]' },
        { title: 'Total Learners', value: stats.totalLearners.toLocaleString('en-US'), icon: Users, colorClass: 'bg-[#e8def8] text-[#6750a4]' },
