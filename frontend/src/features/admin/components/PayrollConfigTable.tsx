            ...
            <table className="w-full text-left border-collapse min-w-200">
                <thead>
                    <tr className="bg-[#f7fafc] border-b border-[#e0e3e5]">
                        <th className="py-3 px-4 text-sm font-semibold text-[#43474e]">Employee</th>
                        <th className="py-3 px-4 text-sm font-semibold text-[#43474e]">Role</th>
                        <th className="py-3 px-4 text-sm font-semibold text-[#43474e]">Base / Session Rate</th>
                        <th className="py-3 px-4 text-sm font-semibold text-[#43474e]">OT Rate / Hr</th>
                    ...
                    {configs.map(c => (
                        <tr key={c.staffId} className="border-b border-[#e0e3e5] hover:bg-[#f7fafc]">
                            <td className="py-3 px-4">
                                ...
                                <div className="text-xs text-[#74777f]">{c.email} • {c.accountCode}</div>
                            </td>
