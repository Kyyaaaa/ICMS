...
import { Star, X, Loader2, BookOpen } from 'lucide-react';
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#00142d]/80 backdrop-blur-md animate-fade-in transition-all duration-300">
            ...
            <div className="w-full max-w-4xl rounded-[2rem] shadow-2xl overflow-hidden flex flex-col md:flex-row relative animate-scale-up bg-white">
                ...
                {/* Left Side: Course Info (Gradient & Glassmorphism) */}
                <div className="w-full md:w-5/12 p-10 flex flex-col items-center justify-center relative overflow-hidden bg-gradient-to-br from-[#0061a5] via-[#207cca] to-[#4facfe]">
                    {/* Decorative Background Elements */}
                    <div className="absolute top-0 left-0 w-64 h-64 bg-white/20 rounded-full blur-[80px] -translate-y-1/2 -translate-x-1/3"></div>
                    <div className="absolute bottom-0 right-0 w-48 h-48 bg-[#fff]/30 rounded-full blur-[60px] translate-y-1/4 translate-x-1/4"></div>

                    <div className="relative z-10 flex flex-col items-center w-full">
                        {/* Course Icon */}
                        <div className="relative mb-6 group cursor-pointer">
                            <div className="absolute inset-0 bg-gradient-to-tr from-[#ffffff] to-[#e3f2fd] rounded-full blur-md opacity-60 group-hover:opacity-100 transition-opacity duration-500"></div>
                            <div className="w-28 h-28 rounded-full bg-white text-[#0061a5] flex items-center justify-center shadow-xl relative border-4 border-white/20 backdrop-blur-sm">
                        ...
                        <div className="text-center w-full space-y-4">
                            <div className="bg-white/10 backdrop-blur-md border border-white/20 px-6 py-3 rounded-2xl shadow-sm">
                                <h3 className="text-white font-extrabold text-2xl truncate tracking-tight">{courseName}</h3>
                            </div>
                            
                            <div className="bg-white/10 backdrop-blur-md border border-white/20 px-6 py-5 rounded-2xl shadow-sm w-full">
                                <span className="inline-block px-3 py-1 bg-white/20 text-white text-xs font-bold uppercase tracking-wider rounded-lg mb-3">
                                    Course Evaluation
                                </span>
                                <p className="text-white/90 text-sm leading-relaxed">
                                    Your honest feedback helps us improve the curriculum, materials, and overall learning experience.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="w-full md:w-7/12 p-10 flex flex-col bg-white">
                    <div className="mb-8">
                        <h2 className="text-2xl font-extrabold text-[#002045] tracking-tight mb-2">Evaluate Course</h2>
                        <p className="text-[#74777f] text-sm">Rate the course content, pace, and structure.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="flex-1 flex flex-col gap-8">
                        ...
                        <div className="flex-1 flex flex-col relative">
                            ...
                            <textarea 
                                className="w-full flex-1 min-h-[160px] p-5 bg-[#f8f9fa] border border-[#e0e3e5] rounded-2xl resize-none focus:outline-none focus:border-[#0061a5] focus:ring-4 focus:ring-[#0061a5]/10 text-[#181c1e] text-base transition-all duration-300 placeholder:text-[#a8aeb4]"
                                placeholder="Describe what you liked about the course and any areas for improvement..."
                                value={review}
                                maxLength={500}
