    ...
    return (
        <div className="w-full max-w-110 mx-auto">
            ...
            <div className="mb-10 animate-fade-in-up">
                <h1 className="text-[48px] leading-14 font-bold tracking-[-0.02em] text-[#002045] mb-2">Welcome Back</h1>
                <p className="text-[18px] leading-7 text-[#43474e]">Log in to the IELTS Center Management System to continue managing your institution.</p>
            </div>
            ...
            <form className={`space-y-6 ${showError ? 'animate-shake' : ''}`} onSubmit={handleLogin}>
                ...
                <div className="space-y-2 group animate-fade-in-up" style={{ animationDelay: '100ms' }}>
                    <label className="block text-[14px] leading-4 font-semibold tracking-wider text-[#181c1e]" htmlFor="email">Email Address</label>
                ...
                <div className="space-y-2 group animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                    <div className="flex items-center justify-between">
                        <label className="block text-[14px] leading-4 font-semibold tracking-wider text-[#181c1e]" htmlFor="password">Password</label>
                        <Link className="text-[12px] leading-4 font-medium text-[#0061a5] hover:text-[#002045] transition-colors underline-offset-2 hover:underline" to="/forgot-password">Forgot Password?</Link>
                    </div>
                    <div className="relative transition-transform duration-300 hover:scale-[1.01]">
                    ...
                    {showError && (
                        <p className="text-[#ba1a1a] text-[13px] leading-4 flex items-center gap-1.5 mt-1.5 font-medium animate-fade-in">
            ...
            <div className="mt-6 relative animate-fade-in" style={{ animationDelay: '500ms' }}>
                ...
                <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-[#f7fafc] text-[#43474e] text-[12px] leading-4 font-medium uppercase tracking-wider">Or continue with</span>
                </div>
            </div>

            <div className="mt-6 animate-fade-in" style={{ animationDelay: '600ms' }}>
                <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-[#c4c6cf] rounded-[8px] shadow-sm bg-[#f7fafc] text-[#181c1e] text-[14px] leading-4 font-semibold tracking-wider hover:bg-[#ebeef0] active:scale-[0.98] transition-colors duration-200" type="button">
            ...
            <p className="mt-10 text-center text-[14px] leading-5 text-[#43474e] animate-fade-in" style={{ animationDelay: '700ms' }}>
                Don't have an account?{' '}
                <Link className="text-[14px] leading-4 font-semibold tracking-wider text-[#0061a5] hover:text-[#002045] transition-colors hover:underline" to="/register">Register an account</Link>
            </p>
        </div>
    );
};
