        ...
        <div className="space-y-6 animate-fade-in-up pb-10">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex gap-2">
                    <Link to={`/staff/classes/edit/${id}`} className="px-4 py-2 bg-white border border-[#c4c6cf] text-[#43474e] rounded-lg font-semibold hover:bg-gray-50 flex items-center gap-2">
                        <Edit className="w-4 h-4" /> Edit Class Info
                    </Link>
                    <button
                        onClick={async () => {
            ...
            <div className="flex border-b border-[#e0e3e5] mb-6">
                ...
                <button
                    ...
                    className={`px-6 py-3 font-semibold text-sm border-b-2 transition-colors ${activeTab === 'attendance' ? 'border-[#0061a5] text-[#0061a5]' : 'border-transparent text-[#74777f] hover:text-[#002045]'}`}
                >
                    Manage Attendance
                </button>
                <button
