...
const Homepage = () => {
    ...
    return (
        <div className="bg-[#f7fafc] text-[#181c1e] text-[16px] leading-6 font-sans min-h-screen flex flex-col">
            ...
            <main className="grow">
                ...
                <section id="about" className="relative w-full py-20 lg:py-30 flex items-center justify-center overflow-hidden bg-[#f7fafc]">
                    ...
                    <div className="relative z-10 w-full max-w-360 mx-auto px-4 lg:px-8 flex flex-col lg:flex-row items-center gap-16">
                        <div className="flex-1 flex flex-col items-start text-left">
                            <span className="px-4 py-1.5 bg-[#d6e3ff] text-[#001b3c] font-bold text-[14px] rounded-full mb-6 shadow-sm inline-flex items-center gap-2 border border-[#adc7f7]">
                                <Trophy className="w-4 h-4 text-[#0061a5]" /> Premium IELTS Preparation Center
                            </span>
                            <h1 className="text-[48px] lg:text-[72px] leading-[1.1] tracking-[-0.02em] font-extrabold text-[#002045] mb-6">
                                Unlock Your Global Potential with <span className="text-[#0061a5]">Expert IELTS</span> Training
                            </h1>
                            <p className="text-[18px] lg:text-[22px] leading-[1.6] text-[#43474e] mb-12 max-w-2xl">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                                <a href="#consultation" className="px-8 py-4 bg-[#0061a5] text-white rounded-full text-[16px] font-bold hover:bg-[#002045] transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 flex items-center justify-center gap-3">
                    ...
                    <div className="max-w-360 mx-auto px-4 lg:px-8">
                        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
                            <div className="max-w-2xl">
                                <h2 className="text-[36px] font-extrabold text-[#002045] mb-4">Popular IELTS Courses</h2>
                                <p className="text-[18px] text-[#43474e]">Choose the pathway that matches your current proficiency and target band.</p>
                            </div>
                            <Link to="/courses" className="mt-6 md:mt-0 text-[#0061a5] font-bold text-[16px] hover:underline flex items-center gap-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div className="bg-[#f7fafc] rounded-2xl shadow-sm border border-[#e0e3e5] hover:shadow-xl transition-all duration-300 flex flex-col relative overflow-hidden group cursor-pointer">
                                ...
                                <div className="p-6 flex flex-col grow">
                                    <h3 className="text-[20px] font-bold text-[#002045] mb-3">Masterclass 7.5+</h3>
                                    <p className="text-[14px] text-[#43474e] mb-6 grow">Advanced strategies for reading, rigorous writing structures, and idiomatic speaking.</p>
                            ...
                            <div className="bg-[#f7fafc] rounded-2xl shadow-sm border border-[#e0e3e5] hover:shadow-xl transition-all duration-300 flex flex-col relative overflow-hidden group cursor-pointer">
                                ...
                                <div className="p-6 flex flex-col grow">
                                    <h3 className="text-[20px] font-bold text-[#002045] mb-3">Academic 6.5+</h3>
                                    <p className="text-[14px] text-[#43474e] mb-6 grow">Perfect for beginners aiming for a solid 6.5 band score. Master grammar and core vocab.</p>
                                    <div className="bg-white rounded-xl p-4 mb-6 border border-[#e0e3e5] flex flex-col gap-2 shadow-sm text-[14px]">
                            ...
                            <div className="bg-[#f7fafc] rounded-2xl shadow-sm border border-[#e0e3e5] hover:shadow-xl transition-all duration-300 flex flex-col relative overflow-hidden group cursor-pointer">
                                ...
                                <div className="p-6 flex flex-col grow">
                                    <h3 className="text-[20px] font-bold text-[#002045] mb-3">1-Month Crash Course</h3>
                                    <p className="text-[14px] text-[#43474e] mb-6 grow">Short on time? Intensive 4-week test-taking strategies and daily practice for immediate results.</p>
                                    <div className="bg-white rounded-xl p-4 mb-6 border border-[#e0e3e5] flex flex-col gap-2 shadow-sm text-[14px]">
                            ...
                            <div className="bg-[#f7fafc] rounded-2xl shadow-sm border border-[#e0e3e5] hover:shadow-xl transition-all duration-300 flex flex-col relative overflow-hidden group cursor-pointer">
                                ...
                                <div className="p-6 flex flex-col grow">
                                    <h3 className="text-[20px] font-bold text-[#002045] mb-3">Foundation English</h3>
                                    <p className="text-[14px] text-[#43474e] mb-6 grow">Build a strong English foundation before starting formal IELTS preparation.</p>
                                    <div className="bg-white rounded-xl p-4 mb-6 border border-[#e0e3e5] flex flex-col gap-2 shadow-sm text-[14px]">
                ...
                <section id="tutors" className="w-full py-20 bg-white overflow-hidden border-y border-[#e0e3e5]">
                    <div className="max-w-300 mx-auto px-4 lg:px-8 mb-12 text-center">
                        <h2 className="text-[32px] md:text-[40px] font-extrabold text-[#002045] mb-4">Meet Our Elite Instructors</h2>
                        <p className="text-[16px] md:text-[18px] text-[#43474e] max-w-175 mx-auto">
                    ...
                    <div className="relative w-full overflow-hidden">
                        ...
                        <div className="animate-marquee gap-8 py-8">
                            {marqueeTutors.map((tutor, idx) => (
                                <div key={idx} className="w-[320px] shrink-0 bg-white border border-[#e0e3e5] rounded-3xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group flex flex-col">
                                    ...
                                    <div className="p-7 pt-6 flex flex-col items-center text-center grow bg-white relative">
                                        <h3 className="text-[22px] font-extrabold text-[#002045] mb-1.5">{tutor.name}</h3>
                                        <p className="text-[13px] font-bold text-[#0061a5] mb-4 uppercase tracking-wider">{tutor.role}</p>
                ...
                <section id="stories" className="w-full py-20 bg-white relative border-t border-[#e0e3e5]">
                    <div className="max-w-360 mx-auto px-4 lg:px-8">
                        <div className="text-center mb-12">
                            <h2 className="text-[32px] md:text-[40px] font-extrabold text-[#002045] mb-4">Success Stories</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="bg-[#f7fafc] p-8 rounded-2xl border border-[#e0e3e5] relative hover:shadow-lg transition-all">
                                <div className="absolute top-8 right-8 bg-[#0061a5] text-white font-bold px-3 py-1 rounded-full text-[14px] shadow-sm">8.0 IELTS</div>
                                <Quote className="w-8 h-8 text-[#d2e4ff] mb-4" />
                                <p className="text-[#43474e] text-[15px] leading-relaxed italic mb-6">"The personalized feedback on my Writing tasks was a game changer. I went from a 6.0 to a 7.5 in writing alone!"</p>
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 bg-[#002045] rounded-full flex items-center justify-center text-white font-bold text-[16px]">TA</div>
                                    <div>
                            ...
                            {/* Testimonial 2 */}
                            <div className="bg-[#f7fafc] p-8 rounded-2xl border border-[#e0e3e5] relative hover:shadow-lg transition-all">
                                <div className="absolute top-8 right-8 bg-[#0061a5] text-white font-bold px-3 py-1 rounded-full text-[14px] shadow-sm">7.5 IELTS</div>
                                <Quote className="w-8 h-8 text-[#d2e4ff] mb-4" />
                                <p className="text-[#43474e] text-[15px] leading-relaxed italic mb-6">"The mentors are incredibly supportive. The mock exams felt exactly like the real test, which helped reduce my anxiety."</p>
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 bg-[#0061a5] rounded-full flex items-center justify-center text-white font-bold text-[16px]">ML</div>
                                    <div>
                            ...
                            {/* Testimonial 3 */}
                            <div className="bg-[#f7fafc] p-8 rounded-2xl border border-[#e0e3e5] relative hover:shadow-lg transition-all">
                                <div className="absolute top-8 right-8 bg-[#0061a5] text-white font-bold px-3 py-1 rounded-full text-[14px] shadow-sm">7.0 IELTS</div>
                                <Quote className="w-8 h-8 text-[#d2e4ff] mb-4" />
                                <p className="text-[#43474e] text-[15px] leading-relaxed italic mb-6">"I only had 1 month to prepare. The intensive strategies taught here were exactly what I needed to achieve my target."</p>
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 bg-[#adc7f7] rounded-full flex items-center justify-center text-[#001d37] font-bold text-[16px]">HN</div>
                                    <div>
                ...
                <section id="consultation" className="w-full py-20 bg-[#0061a5] relative overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-300 mx-auto px-4 lg:px-8 flex flex-col lg:flex-row justify-between items-center gap-16">
                        ...
                        <div className="w-full lg:flex-1 text-left text-white">
                            <div className="inline-block bg-[#002045] text-[#adc7f7] text-[12px] font-bold tracking-widest uppercase px-4 py-2 mb-6 rounded-full shadow-sm">
                                Why Choose ICMS?
                            </div>
                            <h2 className="text-[36px] md:text-[48px] leading-[1.1] font-extrabold mb-6 text-white">
                                Master IELTS with <br/>
                                <span className="text-[#d2e4ff]">Confidence</span>
                            </h2>
                            <p className="text-[16px] md:text-[18px] font-medium mb-10 max-w-[90%] text-white/90">
                        ...
                        <div className="w-full lg:w-105 shrink-0">
                            <div className="bg-white rounded-2xl p-8 shadow-2xl border border-[#e0e3e5]">
                                <h3 className="text-[22px] font-extrabold text-[#002045] mb-2 text-center">Get Free Advice</h3>
                                <p className="text-center text-[13px] text-[#43474e] mb-6">Leave your details and we'll be in touch shortly.</p>
                                
                                <form className="flex flex-col gap-4">
                                    <div>
                                        <label className="block text-[12px] font-bold text-[#002045] mb-1.5 uppercase tracking-wide">Full Name *</label>
                                    ...
                                    <div>
                                        <label className="block text-[12px] font-bold text-[#002045] mb-1.5 uppercase tracking-wide">Phone Number *</label>
                                    ...
                                    <div>
                                        <label className="block text-[12px] font-bold text-[#002045] mb-1.5 uppercase tracking-wide">Email Address</label>
                                    ...
                                    <div>
                                        <label className="block text-[12px] font-bold text-[#002045] mb-1.5 uppercase tracking-wide">Course of Interest</label>
                                    ...
                                    <div>
                                        <label className="block text-[12px] font-bold text-[#002045] mb-1.5 uppercase tracking-wide">Message (Optional)</label>
                                    ...
                                    <button type="button" className="w-full py-3 mt-2 bg-[#002045] text-white text-[14px] font-bold uppercase tracking-wider rounded-xl hover:bg-[#00142d] hover:shadow-lg transition-all flex items-center justify-center gap-2">
                                        Submit Request
                                    </button>
                                </form>
                            </div>
            ...
            <footer className="bg-[#00142d] text-[#f1f4f6] w-full pt-20 pb-10 border-t-4 border-[#0061a5]">
                <div className="max-w-300 mx-auto px-4 lg:px-8 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-12 gap-10 lg:gap-8">
                    ...
                    <div className="col-span-1 md:col-span-3 lg:col-span-5 flex flex-col items-start">
                        <div className="text-[28px] font-extrabold text-white mb-5 flex items-center gap-2">
                            <BookOpen className="w-8 h-8 text-[#adc7f7]" /> ICMS
                        </div>
                        <p className="text-[#a8aeb4] text-[14px] leading-6 mb-6 max-w-75">
                    ...
                    <div className="col-span-1 lg:col-span-4">
                        <h4 className="text-[16px] font-bold text-white mb-6 uppercase tracking-wider">Our Programs</h4>
                    ...
                    <div className="col-span-1 lg:col-span-3">
                        <h4 className="text-[16px] font-bold text-white mb-6 uppercase tracking-wider">Explore</h4>
                        <div className="flex flex-col gap-4">
